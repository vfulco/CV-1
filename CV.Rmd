...
\begin{itemize}
  ...
  \item Fostered expertise in animal handling, EEG signal processing, sleep scoring, rodent surgery, and animal behavior.
\end{itemize} 
...
```{r echo = F}
# 2016 $\\$
# \hspace*{.25cm} Associated Professional Sleep Societies (APSS) annual SLEEP meeting, Denver, CO. $\\$ 
# \hspace*{.75cm} 1. *Sleep Disruption is Associated with Fearful Behavior in a Mouse Model of Post-Traumatic Stress*. $\\$
# \hspace*{.75cm} 2. *Developmental Sleep Fragmentation Impairs Social Development in Male, but not Female, Prairie Voles*.
```
